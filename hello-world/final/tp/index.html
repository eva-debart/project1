...
<head>
    <meta charset="UTF-8">
    <title>Module 1 - Final </title>
	<link rel="stylesheet" href="css/style.css">
</head>
<body>
    <div class="container">
    <header>
        <img src="img/seal-ny.png" alt="seal New-York"> 
        <h1 class='title'>New york city</h1>
        <img src="img/new-york.jpg" alt="Photo de new-york">
    </header>
    ...
    <main class='clearfix'>
        ...
        <article class="clearfix">
            <h3>Le drapeau</h3>
            <img src="img/flag-ny.png" alt="flag de new york" class="img-right">
            ...
            <p>En son centre est reproduit, en bleu, <strong>le sceau de la ville</strong>. Sur ce dernier figurent plusieurs éléments symboliques :</p>
            </article>
            <ul>
                ...
                <li>-<em>Le moulin à vent</em>, les tonneaux de farine et les fleurs en couronne, représentant l’industrie new yorkaise.</li>
                <li>- <em>La devise latine </em>« Sigillum Civitatis Novi Eboraci » qui signifie : « Le sceau de la ville de New York ».</li>
            </ul>
            
        <article>
            <h3>La statue de la Liberté</h3>
            <img  src="img/statue-of-liberty.jpg" alt=" photo de la statue de la liberté " class="img-left">
           <p>Située sur <strong>la Liberty Island</strong>, au sud de Manhattan à l'embouchure de l'Hudson et à proximité d'Ellis Island. Son véritable nom est <em>Liberty Enlightening the World</em>, en français La Liberté éclairant le monde, mais est plus connue sous le nom de statue de la Liberté (Statue of Liberty).</p> 
           <p> Pesant 204 tonnes et mesurant 92,9 mètres, elle est construite en France et offerte par le peuple français, en signe d'amitié entre les deux nations et pour célébrer le centenaire de la Déclaration d'indépendance américaine.</p>
            ...
            <p>
             raison de son statut de monument universel, la statue de la Liberté a été copiée et reproduite à différentes échelles et en divers endroits du globe. On en compte de nombreuses en France, la plus connue étant celle située à l'extrémité de l'île aux Cygnes à la hauteur du pont de Grenelle, près de l'ancien atelier de Bartholdi, qui est haute de 11,50 m. D'autres répliques sont également disséminées de part le monde : à Las Vegas, au Japon, en Espagne, au Kosovo ...</p>
            </article>
        <article>
            <h2 id="geographie">Géographie</h2>
            <img src="img/brooklyn-bridge.jpg" alt="Photo du pont de Brooklyn" class="img-right">
            <p>
            La ville s'étend sur plusieurs îles : la plus peuplée est celle de <strong>Manhattan</strong> où se trouve le cœur économique et culturel de l'agglomération. Governors Island, <strong>Liberty Island et Ellis Island</strong> sont de petites îles au sud de Manhattan dont les lieux historiques sont visités par les touristes. Staten Island est l'île la plus au sud de New York. Les arrondissements de<em>Brooklyn et Queens</em>  occupent la partie occidentale de Long Island alors que <em>le Bronx</em> se trouve sur le continent, dans le Sud d'une presqu'île.</p>
            <p>
            Cette configuration insulaire nécessite la présence de nombreux ponts et tunnels qui relient les différentes parties de l'agglomération. Un service de traversiers permet également aux New-Yorkais de se déplacer facilement. Plusieurs détroits comme le<em>Long Island Sound ou The Narrows</em>  séparent les différentes îles. Les eaux profondes de la baie de New York et les côtes très découpées fournissent de nombreuses autres petites baies abritées. Le site de New York apparaît à la fois comme un atout (ouverture maritime, défense naturelle) mais aussi comme un risque (inondations, élévation de la mer, raz-de-marée) pour la métropole.</p>
        </article>
        <article>
            <h2 id="demographie"> Démographie</h2>
            <img src="img/taxi-cab.jpg" alt="photo de taxis de new york" class="img-left">
            <p>
    ...
    <footer>
        <br>
        <img src="img/logo-3wa.png" alt="logo 3W academy">
        
         <a rel="license" href="https://3wa.fr/propriete-materiel-pedagogique" target="_blank" class="copyright">Ce matériel pédagogique est la propriété de la 3W Academy</a>
        <small>cet exercice a été réalise par Catherine Daros</small>
    </footer>
    </div>
</body>
</html>